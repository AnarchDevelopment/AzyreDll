...
void Watermark::RenderMenu() {
    ...
    if (GUI::BeginModuleSettings("Watermark", &g_showWatermark)) {
        ...
        if (!g_useImage) {
            ...
            ImGui::Combo("Animation", &g_animStyle, animStyles, IM_ARRAYSIZE(animStyles));
            if (g_animStyle == 1) {
                ImGui::SliderFloat("Slide Distance", &g_slideOffset, 5.0f, 120.0f, "%.0f px");
            }
            ...
            ImGui::SetNextItemWidth(-1.0f);
            ImGui::Combo("Snap Corner", &g_snapCorner, snapModes, IM_ARRAYSIZE(snapModes));
            if (g_snapCorner > 0) {
                ImGui::SliderFloat("Snap Padding", &g_snapPadding, 0.0f, 60.0f, "%.0f px");
            }
            ...
            if (g_showOutline) {
                ...
                ImGui::SliderFloat("Outline Width", &g_outlineWidth, 0.5f, 4.0f, "%.1f px");
            }
            ...
            if (g_showBackground) {
                ...
                ImGui::SliderFloat("BG Radius", &g_bgRadius, 0.0f, 20.0f, "%.0f px");
                ImGui::SliderFloat("BG Padding X", &g_bgPadX, 0.0f, 30.0f, "%.0f px");
                ImGui::SliderFloat("BG Padding Y", &g_bgPadY, 0.0f, 30.0f, "%.0f px");
            }
        } else {
            ImGui::Separator();
