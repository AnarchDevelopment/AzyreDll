...
public:
    ...
    // Window message handling (replaces the game WndProc while menu is active)
    static LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
    
    // Cursor / world state helpers
    static bool IsWindowsCursorVisible();
    static bool IsInWorld();
    static void DebugLogCursorState(const char* tag);
