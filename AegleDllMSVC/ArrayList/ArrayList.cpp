...
namespace ArrayList {
    ...
    void RenderMenu() {
        ...
        if (GUI::BeginModuleSettings("ArrayList", &g_enabled)) {
            ...
            ImGui::SliderFloat("Size", &g_size, 0.5f, 2.0f, "%.2fx");
            ...
            if (g_chromaText || g_chromaSideBar) {
                ImGui::SliderFloat("Chroma Speed", &g_chromaSpeed, 0.5f, 6.0f, "%.1fx");
            }
            GUI::RenderCustomSwitch("Text Glow", &g_glowEnabled);
            if (g_glowEnabled) {
                ImGui::SliderFloat("Glow Strength", &g_glowStrength, 1.0f, 8.0f, "%.0f");
            }
            ...
            ImGui::Combo("##al_anim_style", &g_animationStyle, animStyles, IM_ARRAYSIZE(animStyles));
            const char* sideModes[] = { "Auto", "Left", "Right" };
            ImGui::SetNextItemWidth(-1.0f);
            ImGui::Combo("##al_side_mode", &g_sideMode, sideModes, IM_ARRAYSIZE(sideModes));
            ...
            ImGui::SetNextItemWidth(-1.0f);
            ImGui::Combo("##al_bg_mode", &g_backgroundMode, bgModes, IM_ARRAYSIZE(bgModes));

            if (g_backgroundMode == 1) {
                ImGui::SliderFloat("Blur Radius", &g_blurRadius, 1.0f, 20.0f, "%.1f");
                ImGui::SliderFloat("Blur Opacity", &g_blurOpacity, 0.0f, 1.0f, "%.2f");
            ...
            if (g_showSideBar) {
                ImGui::SliderFloat("Side Bar Width", &g_sideBarWidth, 1.0f, 8.0f, "%.0f px");
            ...
            ImGui::SliderFloat("Row Spacing", &g_rowSpacing, 0.0f, 12.0f, "%.1f px");
            ImGui::SliderFloat("Animation Speed", &g_animationSpeed, 0.2f, 3.0f, "%.1fx");
            ...
            if (g_showBorder) {
                ...
                ImGui::SliderFloat("Border Width", &g_borderWidth, 0.5f, 3.0f, "%.1f px");
            }

            GUI::RenderCustomSwitch("Text Shadow", &g_textShadow);
            if (g_textShadow) {
                ImGui::SliderFloat("Shadow Offset", &g_textShadowOffset, 0.5f, 4.0f, "%.1f px");
            }
